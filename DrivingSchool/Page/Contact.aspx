...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentDetail" runat="server">
    <div id="container" style="margin-left: 50px;">
        ...
        <div style="margin-left: 50px;">
            ...
            <hr />
            <h4>โรงเรียนมิตรร่วมใจสอนขับรถ สำนักงานใหญ่ (ใกล้โรงพบาบาลสิรินธร) 498 ถนน.อ่อนนุช แขวง ประเวศ เขต.ประเวศ กรุงเทพมหานคร 10250</h4>
            <h5>โทร <a data-rel="external" href="tel:02-329-0188">02-329-0188</a>, <a data-rel="external" href="tel:02-329-0187">02-329-0187</a></h5>
        </div>
    </div>
</asp:Content>
