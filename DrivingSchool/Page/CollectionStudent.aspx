<%@ Page Title="" Language="C#" MasterPageFile="~/MainFrame.Master" AutoEventWireup="true" CodeBehind="CollectionStudent.aspx.cs" Inherits="DrivingSchool.Page.CollectionStudent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentDetail" runat="server">
    ...
    <div id="container" style="margin-left: 50px;">
        <h4 class="featurette-heading">รูปภาพนักเรียนคนเก่งของเรา</h4>
        <hr />
