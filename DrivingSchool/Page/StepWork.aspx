...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentDetail" runat="server">
    <div style="margin-left: 50px; margin-right: 200px;">
        ...
        <ul>
            ...
            <li class="liText">ชั่วโมงที่ 7 - 10 การหยุดรถบนทางราบและการหยุดรถ ออกรถ บนทางราดชัน หรือสะพาน วิ่งออกถนนใหญ่ในเส้นทางต่างๆ เช่น ลาดกระบัง มีนบุรี ศรีนครินทร์ พระโขนง บางกะปิ ทางด่วนต่างๆ</li>
        </ul>
        <%--</div>--%>
        <hr class="underline" />
        ...
        <ul>
            <li class="liText">สอนด้วยรถเก๋งติดแอร์ และรถกระบะติดแอร์ สภาพดี</li>
            ...
            <li class="liText">ผู้สอนมีทักษะในการสอน โดนจะสอนแบบคนต่อคน</li>
