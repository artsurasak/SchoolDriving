...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentDetail" runat="server">
    <div style="margin-left: 50px; margin-right: 200px;">
        ...
        <div style="margin-top: 30px; margin-left: 50px;">
            <h1>หลักสูตรการอบรมและทดสอบสำหรับผู้ขอรับใบอนุญาติขับรถ</h1>
            <ul>
            ...
            <hr class="underline" />
            <h1>ขั้นตอนการสมัครเรียน</h1>
            <ul>
                <li class="liText">ทดสอบสมรรถภาพร่างกาย</li>
                <ul>
                    <li class="liText">1. ทดสอบการมองเห็นสี</li>
                    <li class="liText" style="list-style-type: none;">
                        <img src="../Img/Test/รุ่นที่ 1/S__6840323.jpg" style="width: auto; height: auto; margin-left: 100px; height: 300px; background-repeat: no-repeat" alt="imgBack" /></li>
                    <li class="liText">2. ทดสอบสายตาทางกว้างและทางลึก</li>
                    <li class="liText" style="list-style-type: none;">
                        <img src="../Img/Test/รุ่นที่ 1/S__6840325.jpg" style="width: auto; height: auto; margin-left: 100px; height: 300px; background-repeat: no-repeat" alt="imgBack" /></li>
                    <li class="liText">3. ทดสอบปฏิกิริยาในการเบรครถ</li>
                    <li class="liText" style="list-style-type: none;">
                        <img src="../Img/Test/รุ่นที่ 1/S__6840326.jpg" style="width: auto; height: auto; margin-left: 100px; height: 300px; background-repeat: no-repeat" alt="imgBack" /></li>
                </ul>
                <li class="liText">ลงทะเบียน / เขียนใบสมัคร</li>
                <li class="liText">การเรียนการสอน</li>
                <ul>
                    <li class="liText">ภาคทฤษฎี</li>
                    <li class="liText">ภาคปฎิบัติ</li>
                </ul>
                <li class="liText">การทดสอบภาคทฤษฎี</li>
                <li class="liText">การทดสอบภาคปฎิบัติ</li>
                <li class="liText">รับหนังสือรับรอง</li>
            </ul>
            <hr class="underline" />
