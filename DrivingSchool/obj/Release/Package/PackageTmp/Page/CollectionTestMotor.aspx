<%@ Page Title="" Language="C#" MasterPageFile="~/MainFrame.Master" AutoEventWireup="true" CodeBehind="CollectionTestMotor.aspx.cs" Inherits="DrivingSchool.Page.CollectionTestMotor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentDetail" runat="server">
    ...
    <div id="container" style="margin-left: 50px;">
        ...
        <hr />
        <h3 style="margin-left: 50px; font-weight: bold;">บรรยากาศการเรียนการสอบ</h3>
