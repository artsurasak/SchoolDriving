...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentDetail" runat="server">
    <div id="container" style="margin-left: 50px;">
        ...
        <div style="margin-left: 50px;">
            ...
            <hr />
            <h4>โรงเรียนสอนขับรถ มิตรร่วมใจ จุดรับสมัคร สุขาภิบาล3 3575/2 ซอย รามคำแหง 89/1 ถนน รามคำแหง แขวง หัวหมาก เขต บางกะปิ กรุงเทพมหานคร 10240</h4>
            <h5>โทร 081-8336128 , 083-199-3458 </h5>
        </div>
    </div>
</asp:Content>
